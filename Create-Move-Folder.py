...
# Paths
new_folder_path = rf'D:\sharefolder2\backup\data space\{formatted_date}'
existing_folder_path = r'D:\sharefolder2\backup\data space\WindowsImageBackup'  # Adjust this to your actual path

# Custom log file path
log_file_path = r'C:\Users\csk\Desktop\windowsmgmt\FInal TEST\log\move.log'
